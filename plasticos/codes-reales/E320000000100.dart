...
void main() async {
  try {
    ...
    final cert = File(path.join(dirProject.path, kCertName));

    String password = kCertPassword;
    ...
    EcfModel ecf = EcfModel(
        ...
        numeroComprobante: 'E320000000101',
        ...
        razonSocialEmisor: 'PLASTICOS Y PROVISIONES PAPO S SRL',
        nombreComercial: 'PLASTICOS Y PROVISIONES PAPO S SRL',
        direccionEmisor:

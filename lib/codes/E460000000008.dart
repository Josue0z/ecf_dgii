...
import 'package:ecf_dgii/src/types/ecf.dart';
    ...
    List<EcfDetailsModel> items = [
      EcfDetailsModel(
          ...
          otraMonedaDetalles: [
            OtraMonedaDetalle(precioOtraMoneda: '7.89', descuentoOtraMoneda: '', recargoOtraMoneda: '', montoItemOtraMoneda: '1184.21')
          ],
          montoItem: '67500.00'),
      EcfDetailsModel(
          cantidad: '100.00',
          ...
          impuestosAdicionales: [],
          otraMonedaDetalles: [
            OtraMonedaDetalle(precioOtraMoneda: '3.51', descuentoOtraMoneda: '', recargoOtraMoneda: '', montoItemOtraMoneda: '350.88')
          ],
          montoItem: '20000.00'),
      EcfDetailsModel(
          cantidad: '120.00',
          ...
          impuestosAdicionales: [],
          otraMonedaDetalles: [
            OtraMonedaDetalle(precioOtraMoneda: '4.39', descuentoOtraMoneda: '', recargoOtraMoneda: '', montoItemOtraMoneda: '526.32')
          ],
          montoItem: '30000.00'),
    ];
    ...
    EcfModel ecf = EcfModel(
        ...
        numeroComprobante: 'E460000000008',
        codigoModificacion: '',

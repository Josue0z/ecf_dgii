...
class EcfModel {
 ...
 EcfModel copyWith({
  ...
  return EcfModel(
    ...
    tempDirName: tempDirName ?? this.tempDirName,
    indicadorMontoGravado: indicadorMontoGravado ?? this.indicadorMontoGravado,
    numeroComprobante: numeroComprobante ?? this.numeroComprobante,
    codigoModificacion: codigoModificacion ?? this.codigoModificacion,
    fechaEmision: fechaEmision ?? this.fechaEmision,
    fechaVencimiento: fechaVencimiento ?? this.fechaVencimiento,
    fechaEmisionNcfModificado: fechaEmisionNcfModificado ?? this.fechaEmisionNcfModificado,
    razonModificacion: razonModificacion ?? this.razonModificacion,
    tipoIngreso: tipoIngreso ?? this.tipoIngreso,
    tipoPago: tipoPago ?? this.tipoPago,
    formasDePagos: formasDePagos ?? this.formasDePagos,
    sucursal: sucursal ?? this.sucursal,
    direccionEmisor: direccionEmisor ?? this.direccionEmisor,
    municipio: municipio ?? this.municipio,
    provincia: provincia ?? this.provincia,
    telefonoEmisor1: telefonoEmisor1 ?? this.telefonoEmisor1,
    telefonoEmisor2: telefonoEmisor2 ?? this.telefonoEmisor2,
    telefonoEmisor3: telefonoEmisor3 ?? this.telefonoEmisor3,
    ...
    correoEmisor: correoEmisor ?? this.correoEmisor,
    website: website ?? this.website,
    actividadEconomica: actividadEconomica ?? this.actividadEconomica,
    codigoVendedor: codigoVendedor ?? this.codigoVendedor,
    informacionAdicionalEmisor: informacionAdicionalEmisor ?? this.informacionAdicionalEmisor,
    rncComprador: rncComprador ?? this.rncComprador,
    identificadorExtranjero: identificadorExtranjero ?? this.identificadorExtranjero,
    razonSocialComprador: razonSocialComprador ?? this.razonSocialComprador,
    nombreComprador: nombreComprador ?? this.nombreComprador,
    contactoComprador: contactoComprador ?? this.contactoComprador,
    correoComprador: correoComprador ?? this.correoComprador,
    telefonoAdicional: telefonoAdicional ?? this.telefonoAdicional,
    direccionComprador: direccionComprador ?? this.direccionComprador,
    municipioComprador: municipioComprador ?? this.municipioComprador,
    provinciaComprador: provinciaComprador ?? this.provinciaComprador,
    codigoInternoComprador: codigoInternoComprador ?? this.codigoInternoComprador,
    fechaEntrega: fechaEntrega ?? this.fechaEntrega,
    fechaOrdenCompra: fechaOrdenCompra ?? this.fechaOrdenCompra,
    numeroOrdenCompra: numeroOrdenCompra ?? this.numeroOrdenCompra,
    numeroFacturaInterna: numeroFacturaInterna ?? this.numeroFacturaInterna,
    numeroPedidoInterno: numeroPedidoInterno ?? this.numeroPedidoInterno,
    zonaVenta: zonaVenta ?? this.zonaVenta,
    rutaVenta: rutaVenta ?? this.rutaVenta,
    paisDestino: paisDestino ?? this.paisDestino,
    conductor: conductor ?? this.conductor,
    documentoTransporte: documentoTransporte ?? this.documentoTransporte,
    ficha: ficha ?? this.ficha,
    placa: placa ?? this.placa,
    rutaTransporte: rutaTransporte ?? this.rutaTransporte,
    zonaTransporte: zonaTransporte ?? this.zonaTransporte,
    ...
    totalGravado18: totalGravado18 ?? this.totalGravado18,
    totalGravado16: totalGravado16 ?? this.totalGravado16,
    totalGravadoTasa0: totalGravadoTasa0 ?? this.totalGravadoTasa0,
    montoExento: montoExento ?? this.montoExento,
    totalItbis: totalItbis ?? this.totalItbis,
    totalItbis18: totalItbis18 ?? this.totalItbis18,
    totalItbis16: totalItbis16 ?? this.totalItbis16,
    totalItbisTasa0: totalItbisTasa0 ?? this.totalItbisTasa0,
    itbis1: itbis1 ?? this.itbis1,
    itbis2: itbis2 ?? this.itbis2,
    itbis3: itbis3 ?? this.itbis3,
    montoTotal: montoTotal ?? this.montoTotal,
    montoPeriodo: montoPeriodo ?? this.montoPeriodo,
    montoAvancePago: montoAvancePago ?? this.montoAvancePago,
    valorPagar: valorPagar ?? this.valorPagar,
    tipoMoneda: tipoMoneda ?? this.tipoMoneda,
    tipoCambio: tipoCambio ?? this.tipoCambio,
    montoGravadoTotalOtraMoneda: montoGravadoTotalOtraMoneda ?? this.montoGravadoTotalOtraMoneda,
    montoGravadoTotalOtraMoneda1: montoGravadoTotalOtraMoneda1 ?? this.montoGravadoTotalOtraMoneda1,
    montoGravadoTotalOtraMoneda2: montoGravadoTotalOtraMoneda2 ?? this.montoGravadoTotalOtraMoneda2,
    montoGravadoTotalOtraMoneda3: montoGravadoTotalOtraMoneda3 ?? this.montoGravadoTotalOtraMoneda3,
    totalItbisOtraMoneda: totalItbisOtraMoneda ?? this.totalItbisOtraMoneda,
    totalItbis1OtraMoneda: totalItbis1OtraMoneda ?? this.totalItbis1OtraMoneda,
    totalItbis2OtraMoneda: totalItbis2OtraMoneda ?? this.totalItbis2OtraMoneda,
    totalItbis3OtraMoneda: totalItbis3OtraMoneda ?? this.totalItbis3OtraMoneda,
    numeroComprobanteModificado: numeroComprobanteModificado ?? this.numeroComprobanteModificado,
    numeroContenedor: numeroContenedor ?? this.numeroContenedor,
    numeroCuentaPago: numeroCuentaPago ?? this.numeroCuentaPago,
    numeroEmbarque: numeroEmbarque ?? this.numeroEmbarque,
    numeroReferencia: numeroReferencia ?? this.numeroReferencia,
    nombrePuertoDesembarque: nombrePuertoDesembarque ?? this.nombrePuertoDesembarque,
    nombrePuertoEmbarque: nombrePuertoEmbarque ?? this.nombrePuertoEmbarque,
    nombrePuertoSalida: nombrePuertoSalida ?? this.nombrePuertoSalida,
    cantidadBulto: cantidadBulto ?? this.cantidadBulto,
    contactoEntrega: contactoEntrega ?? this.contactoEntrega,
    condicionesEntrega: condicionesEntrega ?? this.condicionesEntrega,
    rncOtroContribuyente: rncOtroContribuyente ?? this.rncOtroContribuyente,
    tipoCuentaPago: tipoCuentaPago ?? this.tipoCuentaPago,
    indicadorNotaCredito: indicadorNotaCredito ?? this.indicadorNotaCredito,
    unidadBulto: unidadBulto ?? this.unidadBulto,
    unidadPesoBruto: unidadPesoBruto ?? this.unidadPesoBruto,
    unidadPesoNeto: unidadPesoNeto ?? this.unidadPesoNeto,
    ...
    volumenBulto: volumenBulto ?? this.volumenBulto,
    totalCif: totalCif ?? this.totalCif,
    totalFob: totalFob ?? this.totalFob,
    totalIsrRetencion: totalIsrRetencion ?? this.totalIsrRetencion,
    totalItbisRetencion: totalItbisRetencion ?? this.totalItbisRetencion,
    montoTotalOtraMoneda: montoTotalOtraMoneda ?? this.montoTotalOtraMoneda,
    montoExentoOtraMoneda: montoExentoOtraMoneda ?? this.montoExentoOtraMoneda,
    montoImpuestoAdicional: montoImpuestoAdicional ?? this.montoImpuestoAdicional,
    montoNoFacturable: montoNoFacturable ?? this.montoNoFacturable,
    terminoPago: terminoPago ?? this.terminoPago,
    impuestosAdicionales: impuestosAdicionales ?? this.impuestosAdicionales,
    saldoAnterior: saldoAnterior ?? this.saldoAnterior,
    regimenAduanero: regimenAduanero ?? this.regimenAduanero,
    bancoPago: bancoPago ?? this.bancoPago,
    fechaLimitePago: fechaLimitePago ?? this.fechaLimitePago,
    fechaEmbarque: fechaEmbarque ?? this.fechaEmbarque,
    ...
    certBase64: certBase64 ?? this.certBase64,
...
<RFCE xsi:noNamespaceSchemaLocation="$ecfXsdFile" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
  ...
  Uri get uriEcf {
    ...
    params = params.replaceAll('+','%2B')..replaceAll('*','%2A')..replaceAll('&','%26')..replaceAll('#','%23')..replaceAll('!','%21');
